                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            <div class="note note-warning">
                                <h4 class="block"> <b>Unsubscribe</b> </h4>
                                <p> Enter Your e-mail to unsubscribe from our newsletters </p>
                            </div>

                            <!-- BEGIN SAMPLE FORM PORTLET-->
                            <div class="portlet light bordered unsubscribe_box">
                                <div class="portlet-body form">
                                    <form role="form" name="form_reset" id="form_unsubscribe" action="#" method="POST">
                                        <div class="form-body">
                                        ...
                                        <div class="form-actions">
                                            <a type="submit" class="btn blue unsubscribe_btn">Unsubscribe</a>
...
@section('pageCustomJScripts')
    <script type="text/javascript">
            ...
            var handleValidation2 = function() {
                ...
                form2.validate({
                    ...
                    submitHandler: function (form) {
                        success2.show();
                        error2.hide();
                        blockContent('.unsubscribe_box');
                        unsubscribe(); // submit the form
                    }
                });
            }
        ...
        $('.unsubscribe_btn').on('click', function(){
            $('#form_unsubscribe').submit();
        });

        function unsubscribe(){
            $.ajax({
                url: '{{ route('unsubscribe_action', ['token'=>$token]) }}',
                type: "post",
                cache: false,
                data: {
