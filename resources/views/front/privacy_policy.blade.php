                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-purple bold uppercase">BOOK247.COM PRIVACY POLICY</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="well">
                                <p>
                                    Welcome to book247.com. This site (the “Site”) is owned by Rankedin AS. This Privacy Policy is designed to tell you about our practices regarding collection, use and disclosure of information that we may collect from and about you. Please be sure to read this entire Privacy Policy before using or submitting information to this Site.
                                </p>
                                <h4>
                                    Your Consent
                                </h4>
                                ...
                                <p>
                                    Some areas of this Site may require you to submit information in order for you to benefit from the specified features (such as newsletter subscriptions, tips/pointers, order processing and so forth) or to participate in a particular activity (such as sweepstakes or other promotions and so forth). 
                                </p>
                                <h4>
                                ...
                                <ol>
                                    ...
                                    <li style="list-style: lower-roman">
                                        to select companies or organizations which we believe may offer products, services, materials or information of interest to visitors to this Site;
                                    </li>
                                    <li style="list-style: lower-roman">
                                        to third parties we use to support our business (including fulfillment services, technical support, delivery services, chat service providers, email service providers, forum service providers, advertisement sales and management services and financial institutions); 
                                    </li>
                                    <li style="list-style: lower-roman">
                                ...
                                <p>
                                    Your use of this Site is subject to the Terms of Use. If you choose to use this Site, your visit and any dispute over privacy and data collection is subject to this Privacy Policy and our Terms of Use including limitations on damages and application of the law of Norway.
                                </p>
                                <h4>
                                    How to Contact Us
                                </h4>
                                <p>
                                    If you have any questions, comments or concerns about this Privacy Policy or the information practices of this Site, please contact us using the contact form on this site.
                                </p>
                                <h4>
                                    Changes to This Privacy Policy
                                </h4>
                                <p>
                                    If this Privacy Policy changes, the revised policy will be posted on this Site. Please check back periodically, and especially before you provide any personally identifiable information. This Privacy Policy was last updated: [08/17].
                                </p>
                            </div>
                        </div>
                    </div>
