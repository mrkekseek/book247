                                ...
                                <form class="register-form portlet light " method="post" name="user_registration_form" id="user_registration_form">
                                    ...
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label visible-ie8 visible-ie9">Home Club</label>
                                                <input class="form-control placeholder-no-fix" type="text" placeholder="Home Club" name="reg_home_club" />
                                            </div>
                                        </div>
                                    </div>
        ...
        function register_member(){
            $.ajax({
                ...
                data: {
                    ...
                    'home_club': $('input[name="reg_home_club"]').val(),

                    'membership_plan': $('select[name="membership_plan"]').val(),
                    'start_date': $('input[name="start_date"]').val(),
                    'membership_number': $('input[name="membership_number"]').val(),
