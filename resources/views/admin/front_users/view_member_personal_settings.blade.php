                                        ...
                                        <div class="tab-pane active row" id="tab_1_1">
                                            <form role="form" id="form_acc_personal" action="#">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="control-label">
                                                        <div class="input-group input-medium date date-picker" data-date="{{ @$personal->dob_format }}" data-date-format="yyyy-mm-dd" data-date-end-date="-0d" data-date-start-view="decades">
                                                            <input type="text" class="form-control" name="personalDOB" id="personalDOB" value="{{ @$personal->dob_format }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="personalEmail" id="personalEmail" {{ isset($user->sso_user_id)?'disabled':'' }} placeholder="Email Address" class="form-control" value="{{@$personal->personal_email}}" /> </div>
                                                <div class="form-group">
                                                    <label class="control-label">Mobile Phone Number</label>
                                                    <input type="text" name="personalPhone" id="personalPhone" placeholder="12345678910" class="form-control" value="{{@$personal->mobile_number}}" /> </div>
                                                <div class="form-group">
