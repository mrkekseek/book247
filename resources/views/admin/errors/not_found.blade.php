        ...
        <div class="row">
            <div class="col-md-12 page-500 margin-top-40">
                ...
                <div class=" details">
                    ...
                    <p> This error was logged and will be investigated by the administrators
                        <br> </p>
                    <p>
                        If this is the first time you see this, try logout/login then access teh link again.
                        <br> </p>
                </div>
            </div>
        </div>
