                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> {!!$text_parts['table_head_text1']!!}</span>
                        </div>
                    </div>
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="all_permissions">
                            ...
                            @foreach($products as $product)
                                <tr class="odd gradeX">
                                    <td>
                                        <input type="checkbox" class="checkboxes" value="{{ $product->id }}" /> </td>
                                    <td>
                                        <a href="{{ route('admin/shops/products/view',['id' => $product->id]) }}"> {{ $product->name }} </a>
                                    </td>
                                    <td class="center"> {{ @$prodCategories[$product->category_id] }} </td>
                                    <td> {{ $product->brand }} </td>
                                    <td> {{ $product->manufacturer }} </td>
                                    <td> {{ $product->url }} </td>
                                    <td class="center"> {{ @$prodVatRates[$product->vat_rate_id] }}% </td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
                                        ...
                                        <div class="col-md-7">
                                            <select class="form-control input-sm" name="product_vat_rate" id="product_vat_rate">
                                                ...
                                                @foreach ($vatRates as $vatRate)
                                                    <option value="{{ $vatRate->id }}">{{ $vatRate->display_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
