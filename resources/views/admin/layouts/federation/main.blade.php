...
<div class="page-header navbar navbar-fixed-top">
    <!-- BEGIN HEADER INNER -->
    @include('admin.layouts.federation.main_head_nav')
    <!-- END HEADER INNER -->
</div>
<!-- END HEADER -->
...
<div class="page-container">
    ...
    <div class="page-sidebar-wrapper">
        ...
        @include('admin.layouts.federation.main_sidebar_left')
        <!-- END SIDEBAR -->
    </div>
    <!-- END SIDEBAR -->
    <!-- BEGIN CONTENT -->
    ...
    @include('admin.layouts.federation.main_quick_sidebar')
    @endif
    <!-- END QUICK SIDEBAR -->
</div>
<!-- END CONTAINER -->
<!-- BEGIN FOOTER -->
@include('admin.layouts.federation.footer')
<!-- END FOOTER -->
