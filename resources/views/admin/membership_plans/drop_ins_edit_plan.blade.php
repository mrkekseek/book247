                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <select name="sign_out_period" class="form-control input-inline input inline-block">
                                                        @for ($i=1; $i<25;$i++)
                                                            <option {!!$membership_plan->sign_out_period==$i?'selected="selected"':''!!} value="{{ $i }}">{{ $i }} {!!$membership_plan->sign_out_period==$i?' - Current Selection':''!!}</option>
                                                        @endfor
                                                    </select>
                                                    <span class="help-inline inline-block"> months </span>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <input data-color="{{$membership_plan->plan_calendar_color}}" type="text" data-target-id="color-picker-target" class="form-control colorpicker-default" name="membership_color" value="{{$membership_plan->plan_calendar_color}}">
                                                    <!-- /input-group -->
                                                </div>
                                                <div class="col-md-2">
                                                    <input style="background: {{$membership_plan->plan_calendar_color}}" type="text" id="color-picker-target" disabled class="form-control">
                                                </div>
