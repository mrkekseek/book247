                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control input-xlarge" name="profile_name" value="{{ $profile->profile_name }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3"> Company Name </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control input-xlarge" name="company_name" value="{{ $profile->company_name }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 inline"> Company Registration No. </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control inline-block input-xlarge input-inline" name="registration_name" value="{{ $profile->organisation_number }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control inline-block input-xlarge input-inline" name="bank_name" value="{{ $profile->bank_name }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 inline"> Bank Acc No. </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control inline-block input-xlarge input-inline" name="bank_acc_no" value="{{ $profile->bank_account }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control inline-block input-inline input-xlarge" name="address1" value="{{ $profile->address1 }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 inline"> Address Line 2 </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control inline-block input-inline input-xlarge" name="address2" value="{{ $profile->address2 }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 inline"> Postal Code </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control inline-block input-small input-inline" name="postal_code" value="{{ $profile->postal_code }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 inline"> City </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control inline-block input-xlarge input-inline" name="city" value="{{ $profile->city }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 inline"> Region </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control inline-block input-large input-inline" name="region" value="{{ $profile->region }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                @if(!$profile->is_default)
                                                    <button id="make-default" type="button" class="btn btn-primary">Make Default</button>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
...
@section('pageCustomJScripts')
    <script type="text/javascript">
            ...
            var handleValidation1 = function() {
                ...
                form1.validate({
                    ...
                    submitHandler: function (form) {
                        success1.show();
                        error1.hide();
                        update_financial_profile(); // submit the form
                    }
                });
            }
        ...
        function update_financial_profile(){
            $.ajax({
                url: '{{route('admin/settings_financial_profiles/update',['id'=>$profile->id])}}',
                type: "post",
                data: {
