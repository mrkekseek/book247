...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($permissions as $permission){
            $p = \App\Permission::find($permission['id']);
            if ($p) {
                $p->fill(
                    [
        ...
        $permission_role = [
            ['permission_id' => 1,'role_ids' => [ 'owner', 'finance']],
            ['permission_id' => 2,'role_ids' => [ 'owner' ]],
            ['permission_id' => 3,'role_ids' => [ 'owner', 'finance']],
            ['permission_id' => 4,'role_ids' => [ 'owner' ]],
            ['permission_id' => 5,'role_ids' => [ 'owner', 'manager', 'finance', 'employee', 'system-agent']],
            ['permission_id' => 6,'role_ids' => [ 'owner', 'manager', 'finance', 'employee', 'system-agent']],
            ['permission_id' => 7,'role_ids' => [ 'owner', 'manager', 'finance', 'employee']],
            ['permission_id' => 8,'role_ids' => [ 'owner', 'manager', 'finance', 'system-agent']],
            ['permission_id' => 9,'role_ids' => [ 'owner', 'manager', 'finance', 'employee', 'system-agent']],
            ['permission_id' => 10,'role_ids' => [ 'owner', 'manager', 'finance']],
            ['permission_id' => 11,'role_ids' => [ 'owner', 'manager', 'finance']],
            ['permission_id' => 12,'role_ids' => [ 'owner', 'manager']],
            ['permission_id' => 13,'role_ids' => [ 'owner', 'manager']],
            ['permission_id' => 14,'role_ids' => [ 'owner', 'manager']],
            ['permission_id' => 15,'role_ids' => [ 'owner', 'manager']],
            ['permission_id' => 16,'role_ids' => [ 'owner', 'manager']],
            ['permission_id' => 17,'role_ids' => [ 'owner', 'manager']],
            ['permission_id' => 18,'role_ids' => [ 'owner', 'manager']],
            ['permission_id' => 19,'role_ids' => [ 'owner', 'manager']],
            ['permission_id' => 20,'role_ids' => [ 'owner', 'manager', 'finance', 'employee', 'system-agent']],
            ['permission_id' => 21,'role_ids' => [ 'owner', 'manager']],
            ['permission_id' => 22,'role_ids' => [ 'owner' ]],
            ['permission_id' => 23,'role_ids' => [ 'owner' ]]
        ];
...
//        }
        ...
        $name_to_role_id = [];
        foreach (DB::table('roles')->get() as $entry) {
            $name_to_role_id[$entry->name] = $entry->id;
        }
        foreach ($permission_role as $pr) {
            foreach ($pr['role_ids'] as $name) {
                if (!DB::table('permission_role')->where('permission_id',$pr['permission_id'])->where('role_id',$name_to_role_id[$name])->get()){
                    DB::table('permission_role')->insert([
                        'permission_id' => $pr['permission_id'],
