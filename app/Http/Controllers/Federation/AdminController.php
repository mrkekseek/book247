...
//        $x = AnyApi::send_curl('http://rankedinbookingsso-test.azurewebsites.net',[],'/api/Accounts/28','GET');
        ...
        $result =  Api::send_curl(['memberSSOid' => 125 ,'membership_id' => null, 'account_key' => '81381-46565-30640-84804-20809', 'return_url' => "http://book.net/admin/test_api_call" ],'federation_buy_license','POST');
